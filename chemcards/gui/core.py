...
class MultipleChoiceQuiz(QuizBase):
    ...
    def start(self):
        ...
        end_button = tk.Button(self.frame,
                               text="Finish Quiz",
                               command=self.end,
                                width=10,
                                bg="red",
    ...
    def end(self):
        ...
        back_to_main_menu = tk.Button(self.frame,
    ...
    def display_options(self):
        ...
        for i, choice in enumerate(self.current_question.choices):
            ...
            radio_btn = tk.Radiobutton(self.frame,
                                       text=choice,
    ...
    def next_question(self):
        ...
        self.current_question = MultipleChoice(question="What is target of this molecule?",
        ...
        check_answer_button = tk.Button(self.frame,
...
class MainWindow(tk.Tk):
    ...
    def start(self):
        ...
        self.mcq_button = tk.Button(self, 
